...
extern uint32_t __itcm_top__;
extern uint32_t __itcm_end__;
extern uint32_t __data_start__;
extern uint32_t __data_top__;
extern uint32_t __data_end__;
extern uint32_t __dtcm_top__;
extern uint32_t __dtcm_end__;
extern uint32_t __bss_top__;
...
/*----------------------------------------------------------------------------
  External References
 *----------------------------------------------------------------------------*/
extern void SystemInit(void); /* Setup MicroController */
extern void _start(void);     /* Program Entry Point */
...
const pFunc Interrupt_Vectors[] __attribute__((section(".vectors"))) = {
    ...
    (pFunc)&__stack_top__, /* Initial Stack Pointer */
    ...
    /* STM32F745 External Interrupts Handler */
...
void Reset_Handler(void) {
  ...
  /* Get LMA ITCM Section*/
  pSrc = &__itcm_start__;

  /* Copy LMA to VMA ITCM Section */
  for (pDest = &__itcm_top__; pDest < &__itcm_end__;) {
    *pDest++ = *pSrc++;
  }

  /* Get LMA DATA Section */
  pSrc = &__data_start__;

  /* Copy LMA to VMA DATA Section */
